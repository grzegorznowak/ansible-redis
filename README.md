[![Build Status](https://build.spottmedia.com/buildStatus/icon?job=ansible_role_redis)](https://build.spottmedia.com/view/Ansible%20Roles/job/ansible_role_redis/)
